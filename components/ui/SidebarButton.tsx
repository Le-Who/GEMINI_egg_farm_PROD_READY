...
export const SidebarButton: React.FC<SidebarButtonProps> = ({
  ...
  >
    ...
    <span
      className="absolute right-14 bg-emerald-950/90 border border-emerald-700 text-white px-3 py-1.5 rounded-xl text-xs opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-xl backdrop-blur-sm font-bold tracking-wide"
      aria-hidden="true"
    >
      {label}
    </span>

...
// In production, this should come from env, but for client bundle we can hardcode 
// or use a mechanism to inject it. 
// Note: Ensure this matches the ID in your server.js env variables.
